                            ...
                            <tbody>
                                ...
                                foreach ($clientes as $cliente) : ?>
                                    <tr>
                                        ...
                                        <td>
                                            <form id="formEliminarCliente_<?= $cliente->id_cliente ?>" action="../../Backend/cliente/eliminar_cliente.php" method="POST">
                                                <input type="hidden" name="id" value="<?= $cliente->id_cliente ?>">
                                                <button type="button" class="submitBotonEliminar" onclick="confirmarEliminarCliente('<?= $cliente->id_cliente ?>')">
